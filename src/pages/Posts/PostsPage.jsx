    ...
    <div>
      ...
      <div className="flex items-center  gap-4 mb-6">
        <input
          ...
          className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-[50%] lg:w-[80%]  ps-10 p-2.5"
        />

        {/* Add Post Button */}
        <button
          onClick={() => setShowForm((prev) => !prev)}
          className="  text-center bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded-lg font-medium"
        >
      ...
      {showForm && <AddPostForm onClose={() => setShowForm(false)} post={posts} />}
      {/* Posts list */}
